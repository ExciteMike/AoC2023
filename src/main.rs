...
#[test]
fn day14() {
    do_test(14, 109385, 93102);
}
#[test]
fn day15() {
    do_test(15, 506869, 271384);
}
#[test]
fn day16() {
...
#[test]
fn day17() {
    do_test(17, 1155, 1283);
}
#[test]
fn day18() {
    do_test(18, 41019, 96116995735219usize);
}
#[test]
fn day19() {
    do_test(19, 353046, 125355665599537usize);
}
#[test]
fn day20() {
    do_test(20, 737679780, 227411378431763usize);
}
#[test]
fn day21() {
    do_test(21, 3642, 608603023105276usize);
}
#[test]
fn day22() {
    do_test(22, 480, 84021);
}
#[test]
fn day23() {
    do_test(23, 2370, 6546);
}
#[test]
fn day24() {
    do_test(24, 21785, "554668916217145");
}
#[test]
fn day25() {
    do_test(25, 0, 0);
